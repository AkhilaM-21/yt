...
class YouTubeService:
    def __init__(self):
        ...
        self.api_keys = []
        env_keys = os.environ.get('YOUTUBE_API_KEYS', os.environ.get('YOUTUBE_API_KEY', 'AIzaSyByIcDjLKKMIp3-6xplEyHtNN8EchI-kq4'))
        if env_keys:
    ...
    def _execute_api_request(self, url: str, params: dict) -> dict:
        ...
        while True:
            ...
            try:
                ...
                # 403 means quota exceeded, 400 can mean invalid key
